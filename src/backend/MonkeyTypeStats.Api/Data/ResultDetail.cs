...
public class ResultDetail
{
    ...
    public double[]? ChartWpm { get; set; }
    public double[]? ChartBurst { get; set; }
    public double[]? ChartErr { get; set; }
    public double? KeySpacingAverage { get; set; }
    public double? KeySpacingSd { get; set; }
    public double? KeyDurationAverage { get; set; }
    public double? KeyDurationSd { get; set; }
