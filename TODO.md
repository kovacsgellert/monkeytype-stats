...
- implement import/export endpoint
  - export should be a huge JSON that contains both results and result details
  - import should accept an exported JSON and correctly populate the database
